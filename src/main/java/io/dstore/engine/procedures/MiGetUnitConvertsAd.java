...
public final class MiGetUnitConvertsAd {
  ...
  public  static final class Parameters extends
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof io.dstore.engine.procedures.MiGetUnitConvertsAd.Parameters)) {
        return super.equals(obj);
      }
      io.dstore.engine.procedures.MiGetUnitConvertsAd.Parameters other = (io.dstore.engine.procedures.MiGetUnitConvertsAd.Parameters) obj;
  ...
  public  static final class Response extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              row_.add(
                  input.readMessage(io.dstore.engine.procedures.MiGetUnitConvertsAd.Response.Row.parser(), extensionRegistry));
              break;
            }
          }
        }
    ...
    public  static final class Row extends
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof io.dstore.engine.procedures.MiGetUnitConvertsAd.Response.Row)) {
          return super.equals(obj);
        }
        io.dstore.engine.procedures.MiGetUnitConvertsAd.Response.Row other = (io.dstore.engine.procedures.MiGetUnitConvertsAd.Response.Row) obj;
        ...
        result = result && (hasFromUnitSymbol() == other.hasFromUnitSymbol());
        if (hasFromUnitSymbol()) {
          result = result && getFromUnitSymbol()
              .equals(other.getFromUnitSymbol());
        }
        result = result && (hasToUnitSymbol() == other.hasToUnitSymbol());
        if (hasToUnitSymbol()) {
          result = result && getToUnitSymbol()
              .equals(other.getToUnitSymbol());
        }
      ...
      public int hashCode() {
        ...
        if (hasFromUnitSymbol()) {
          hash = (37 * hash) + FROM_UNIT_SYMBOL_FIELD_NUMBER;
          hash = (53 * hash) + getFromUnitSymbol().hashCode();
        }
        if (hasToUnitSymbol()) {
          hash = (37 * hash) + TO_UNIT_SYMBOL_FIELD_NUMBER;
          hash = (53 * hash) + getToUnitSymbol().hashCode();
        }
        if (hasToDateAndTime()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof io.dstore.engine.procedures.MiGetUnitConvertsAd.Response)) {
        return super.equals(obj);
      }
      io.dstore.engine.procedures.MiGetUnitConvertsAd.Response other = (io.dstore.engine.procedures.MiGetUnitConvertsAd.Response) obj;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Converts_Ad\032\023dstore/values.proto\032\033dstore" +
      "/engine/message.proto\032#dstore/engine/met" +
      "ainformation.proto\"\270\002\n\nParameters\0221\n\014fro" +
      "m_unit_id\030\001 \001(\0132\033.dstore.values.integerV" +
      "alue\022\032\n\021from_unit_id_null\030\351\007 \001(\010\022/\n\nto_u" +
      "nit_id\030\002 \001(\0132\033.dstore.values.integerValu" +
      ...
      "e_null\030\354\007 \001(\010\"\326\004\n\010Response\022H\n\020meta_infor" +
      ...
      "(\01321.dstore.engine.mi_GetUnitConverts_Ad" +
      ".Response.Row\032\216\003\n\003Row\022\017\n\006row_id\030\220N \001(\005\0224" +
      "\n\016convert_factor\030\221N \001(\0132\033.dstore.values." +
      "decimalValue\0227\n\022from_date_and_time\030\222N \001(",
      "\0132\032.dstore.values.stringValue\0222\n\014from_un" +
      "it_id\030\223N \001(\0132\033.dstore.values.integerValu" +
      "e\0220\n\nto_unit_id\030\224N \001(\0132\033.dstore.values.i" +
      "ntegerValue\0225\n\020from_unit_symbol\030\225N \001(\0132\032" +
      ".dstore.values.stringValue\0223\n\016to_unit_sy" +
      "mbol\030\226N \001(\0132\032.dstore.values.stringValue\022" +
      "5\n\020to_date_and_time\030\227N \001(\0132\032.dstore.valu" +
      "es.stringValueBV\n\033io.dstore.engine.proce" +
      "duresZ7gosdk.dstore.de/engine/procedures" +
      "/mi_GetUnitConverts_Adb\006proto3"
    };
