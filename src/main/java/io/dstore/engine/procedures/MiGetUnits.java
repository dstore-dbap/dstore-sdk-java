        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              row_.add(input.readMessage(io.dstore.engine.procedures.MiGetUnits.Response.Row.parser(), extensionRegistry));
              break;
            }
          }
        }
