...
public final class FoGetPostingBinariesPu {
  ...
  public  static final class Parameters extends
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof io.dstore.engine.procedures.FoGetPostingBinariesPu.Parameters)) {
        return super.equals(obj);
      }
      io.dstore.engine.procedures.FoGetPostingBinariesPu.Parameters other = (io.dstore.engine.procedures.FoGetPostingBinariesPu.Parameters) obj;
  ...
  public  static final class Response extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              row_.add(
                  input.readMessage(io.dstore.engine.procedures.FoGetPostingBinariesPu.Response.Row.parser(), extensionRegistry));
              break;
            }
          }
        }
    ...
    public  static final class Row extends
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof io.dstore.engine.procedures.FoGetPostingBinariesPu.Response.Row)) {
          return super.equals(obj);
        }
        io.dstore.engine.procedures.FoGetPostingBinariesPu.Response.Row other = (io.dstore.engine.procedures.FoGetPostingBinariesPu.Response.Row) obj;
        ...
        result = result && (hasLastModifiedAtDateAndTimeChar() == other.hasLastModifiedAtDateAndTimeChar());
        if (hasLastModifiedAtDateAndTimeChar()) {
          result = result && getLastModifiedAtDateAndTimeChar()
              .equals(other.getLastModifiedAtDateAndTimeChar());
        }
        result = result && (hasSortNo() == other.hasSortNo());
        if (hasSortNo()) {
          result = result && getSortNo()
        ...
        result = result && (hasLastModifiedAtDateAndTime() == other.hasLastModifiedAtDateAndTime());
        if (hasLastModifiedAtDateAndTime()) {
          result = result && getLastModifiedAtDateAndTime()
              .equals(other.getLastModifiedAtDateAndTime());
        }
      ...
      public int hashCode() {
        ...
        if (hasLastModifiedAtDateAndTimeChar()) {
          hash = (37 * hash) + LAST_MODIFIED_AT_DATE_AND_TIME_CHAR_FIELD_NUMBER;
          hash = (53 * hash) + getLastModifiedAtDateAndTimeChar().hashCode();
        }
        if (hasSortNo()) {
          hash = (37 * hash) + SORT_NO_FIELD_NUMBER;
          hash = (53 * hash) + getSortNo().hashCode();
        ...
        if (hasLastModifiedAtDateAndTime()) {
          hash = (37 * hash) + LAST_MODIFIED_AT_DATE_AND_TIME_FIELD_NUMBER;
          hash = (53 * hash) + getLastModifiedAtDateAndTime().hashCode();
        }
        if (hasBinaryCode()) {
      ...
      public static final class Builder extends
        ...
        private com.google.protobuf.SingleFieldBuilderV3<
          ...
          if (lastModifiedAtDateAndTimeCharBuilder_ == null) {
            lastModifiedAtDateAndTimeCharBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
                io.dstore.values.StringValue, io.dstore.values.StringValue.Builder, io.dstore.values.StringValueOrBuilder>(
        ...
        private com.google.protobuf.SingleFieldBuilderV3<
          ...
          if (lastModifiedAtDateAndTimeBuilder_ == null) {
            lastModifiedAtDateAndTimeBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
                io.dstore.values.TimestampValue, io.dstore.values.TimestampValue.Builder, io.dstore.values.TimestampValueOrBuilder>(
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof io.dstore.engine.procedures.FoGetPostingBinariesPu.Response)) {
        return super.equals(obj);
      }
      io.dstore.engine.procedures.FoGetPostingBinariesPu.Response other = (io.dstore.engine.procedures.FoGetPostingBinariesPu.Response) obj;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ostingBinaries_Pu\032\023dstore/values.proto\032\032" +
      "dstore/engine/engine.proto\"\316\005\n\nParameter" +
      ...
      "y_identifier\030\007 \001(\0132\032.dstore.values.Strin" +
      "gValue\022\'\n\036posting_binary_identifier_null" +
      "\030\357\007 \001(\010\022;\n\027separator_in_ident_vals\030\010 \001(\013",
      "2\032.dstore.values.StringValue\022%\n\034separato" +
      "r_in_ident_vals_null\030\360\007 \001(\010\"\307\005\n\010Response" +
      ...
      "e.engine.fo_GetPostingBinaries_Pu.Respon" +
      "se.Row\032\224\004\n\003Row\022\017\n\006row_id\030\220N \001(\005\0220\n\013descr" +
      "iption\030\221N \001(\0132\032.dstore.values.StringValu" +
      "e\0221\n\014content_type\030\222N \001(\0132\032.dstore.values" +
      ".StringValue\022>\n\031posting_binary_identifie",
      "r\030\223N \001(\0132\032.dstore.values.StringValue\022-\n\010" +
      "filename\030\224N \001(\0132\032.dstore.values.StringVa" +
      "lue\0225\n\017filesize_in_k_b\030\225N \001(\0132\033.dstore.v" +
      "alues.IntegerValue\022H\n#last_modified_at_d" +
      "ate_and_time_char\030\226N \001(\0132\032.dstore.values" +
      ".StringValue\022-\n\007sort_no\030\227N \001(\0132\033.dstore." +
      "values.IntegerValue\022F\n\036last_modified_at_" +
      "date_and_time\030\230N \001(\0132\035.dstore.values.Tim" +
      "estampValue\0220\n\013binary_code\030\251\234\001 \001(\0132\031.dst" +
      "ore.values.BytesValueBY\n\033io.dstore.engin",
      "e.proceduresZ:gosdk.dstore.de/engine/pro" +
      "cedures/fo_GetPostingBinaries_Pub\006proto3"
    };
